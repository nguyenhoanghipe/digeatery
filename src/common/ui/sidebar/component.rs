use crate::common::ui::button::{Button, ButtonVariant};
use crate::common::ui::separator::Separator;
use crate::common::ui::sheet::{
    Sheet, SheetContentClose, SheetDescription, SheetHeader, SheetSide, SheetTitle,
};
use crate::common::ui::skeleton::Skeleton;
use crate::common::ui::tooltip::{Tooltip, TooltipContent, TooltipTrigger};
...
#[css_module("/src/common/ui/sidebar/style.css")]
struct Styles;
...
pub fn SidebarTrigger(
    ...
    rsx! {
        Button {
            ...
            attributes: merged,
            PanelLeft { class: Styles::dx_sidebar_trigger_icon, size: "1rem" }
...
pub fn SidebarMenuButton(
    ...
    rsx! {
        Tooltip { class: Styles::dx_sidebar_tooltip, disabled: hidden,
            TooltipTrigger {
